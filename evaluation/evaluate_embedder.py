...
#QUA A PARTIRE DALLA EVALUATION_TABLE (HA GIà IL DOCUMENTO IPOTETICO) VADO A VALUTARE L'EMBEDDER CON LA GRID SEARCH, PRENDO TUTTI I CHUNK E LI ORDINO, POI VADO A CALCOLARE IL RECALL DOPO OGNI CHUNK AGGIUNTO E LO PLOTTO IN FUNZIONE DEI TOKEN CUMULATIVI, COSì DA VEDERE LA CURVA DI RECALL IN FUNZIONE DEI TOKEN
